...
async function main() {
    ...
    while (true) {
        ...
        if (choice.choice == "Add a new Student") {
            ...
            studentManager.enroll_student(enroll_student.student_id, enroll_student.course);
        }
            ...
            studentManager.pay_student_fees(studentFees.student_id, studentFees.amount);
        }
